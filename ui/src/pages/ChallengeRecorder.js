      ...
      <Paper className={classes.paper}>
        ...
        <Container className={classes.videoContainer}>
          <VideoRecorder
            ...
            allowReview
          />
          <Button className={classes.toggleButton} onClick={this.state.toggleBehavior} variant="contained" color="primary">
...
export default withStyles(styles)(ChallengeRecorder);
