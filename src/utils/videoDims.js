export function calcMainDims(sourceDims, windowSize, {extraHeight = 0, extraWidth = 0} = {}) {
...
export function calcDims(sourceDims,
                         windowSize,
                         miniScale,
                         {extraHeight = 0, extraWidth = 0} = {}) {
  const dims = calcMainDims(sourceDims, windowSize, {extraHeight, extraWidth});
  return {
