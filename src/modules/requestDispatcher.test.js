...
const accessTokenB =
  'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpZGVudGl0eSI6IjEiLCJ0eXBlIjoiYWNjZXNzIiwibmJmIjoxNTY2NDU5MDAwLCJleHAiOjE1NjY0NjAwMDAsInVzZXJfY2xhaW1zIjp7InJvbGVzIjpbeyJhZG1pbiI6ImFkbWluIn1dfSwiaWF0IjoxNTY2NDU5MDAwLCJqdGkiOiIxMTUxZjBlNi03NDBkLTQ3MmQtOTRmNS02YTI5MGJmNGFiZjAifQ.lvjQHxJ2R9Q9blBGXNr3LxA9yEgGwee0XHyelVS-JlA';
const refreshToken =
  'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJuYmYiOjE1NjY0NTkwMDAsImV4cCI6MTU2NjQ4MDAwMCwiaWRlbnRpdHkiOiIxIiwidHlwZSI6InJlZnJlc2giLCJpYXQiOjE1NjY0NTkwMDAsImp0aSI6IjYzYTRkNjAzLTY0MGEtNDdjYS05NWEzLWFmZjQzNTMyYWJlZCJ9.ugfE464AG7Yh6hspSi22MqefsdxqHyWTX5-yn0xY5nA';
...
describe('Testing Unauthenticated requests', () => {
  ...
  test('healthcheck', () => {
    expect.assertions(1);
    expect(rd.get('/healthcheck')).resolves.toHaveProperty('data', 'ok');
    mockAxios.__resolveAll();
  });

  test('missing endpoint', () => {
    expect.assertions(1);
    expect(rd.get('/missing')).rejects.toHaveProperty('response.status', 404);
